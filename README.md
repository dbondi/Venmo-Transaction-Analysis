...
The following analyis was done for eductional purposes.
...
To reduce these cycle and recency problems. We observe that most Venmo usernames have a common theme, as most users go with the default username. Whis is of the form:
#first_name-last_names-number
